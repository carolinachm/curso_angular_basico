...
import { Componente18Component } from './componente18.component';

// Estrutura do teste unitário
describe('Testando componente 18', () => {

  // Inicialização
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [Componente18Component]
    }).compileComponents();
  });
  ...
  it('Validar variável nome', () => {
    ...
    // Fixture
    const fixture = TestBed.createComponent(Componente18Component);

    // Obter as variáveis e funções do componente
    const componente = fixture.componentInstance;

    // Validação
    expect(componente.nome).toEqual('Carol');
